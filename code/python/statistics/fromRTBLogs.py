...
def campaign_click(campaign):
	...
	with open(DataPath.projectPath + "log/" + campaign + "-ttb.log") as fin:
		fin.readline()
		line = fin.readline()
	...
	with open(DataPath.projectPath + "log/" + campaign + "-baseline.log") as fin:
		fin.readline()
		line = fin.readline()
	...
	with open(DataPath.projectPath + "log/" + campaign + "-rtb.log") as fin:
		fin.readline()
		line = fin.readline()
	...
	with open(DataPath.projectPath + "log/" + campaign + "-linear.log") as fin:
		fin.readline()
		line = fin.readline()
